...
.version-badge { display: flex; align-items: center; gap: 8px; padding: 6px 14px; background: white; border: 1px solid rgba(15, 23, 42, 0.08); border-radius: 100px; width: fit-content; box-shadow: 0 4px 15px rgba(0,0,0,0.02); }
...
.gradient-text { background: linear-gradient(to right, #4f46e5, #8b5cf6, #10b981); background-size: 200% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: shine-text 6s linear infinite; }
...
/* Create Card */
.create-btn-card { width: 100%; background: rgba(255, 255, 255, 0.5); backdrop-filter: blur(32px); border-radius: 32px; border: 1px solid white; padding: 32px; display: flex; align-items: center; gap: 24px; text-align: left; position: relative; overflow: hidden; transition: all 0.4s; box-shadow: 0 30px 60px -12px rgba(0,0,0,0.05); cursor: pointer; }
.create-btn-card:hover { transform: translateY(-4px); background: rgba(255, 255, 255, 0.7); box-shadow: 0 40px 80px -12px rgba(99, 102, 241, 0.15); border-color: rgba(99, 102, 241, 0.3); }
...
.workspace-item-card { width: 100%; background: rgba(255, 255, 255, 0.45); backdrop-filter: blur(20px); border-radius: 20px; padding: 16px 20px; display: flex; align-items: center; gap: 16px; border: 1px solid rgba(255, 255, 255, 0.5); transition: all 0.3s cubic-bezier(0.23, 1, 0.32, 1); cursor: pointer; }
.workspace-item-card:hover { background: white; transform: translateX(6px); border-color: rgba(99, 102, 241, 0.2); box-shadow: 0 10px 30px rgba(0,0,0,0.03); }
.ws-icon { width: 44px; height: 44px; background: #f1f5f9; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #64748b; transition: all 0.3s; }
