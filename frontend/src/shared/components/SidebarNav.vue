    ...
    <div v-if="inWorkspace" class="flex-1 flex flex-col gap-4 w-full px-3">
      ...
      >
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Terminal icon -->
          <path v-else-if="item.id === 'terminal'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z" />
          <!-- Members icon -->
