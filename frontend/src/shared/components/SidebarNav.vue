    ...
    <div v-if="inWorkspace" class="flex-1 flex flex-col gap-4 w-full px-3">
      ...
      >
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Sessions icon -->
          <path v-else-if="item.id === 'sessions'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h6m-7 8h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          <!-- Settings icon -->
...
export type TabId = 'chat' | 'members' | 'tasks' | 'sessions' | 'settings' | 'workspaces'
