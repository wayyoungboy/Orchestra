.PHONY: help verify verify-focused build run test reset-data clean backend-run backend-test backend-reset backend-format-check backend-vet frontend-install frontend-dev frontend-build frontend-test frontend-lint
...
help:
	...
	@echo "  make backend-vet    Run go vet for the backend"
