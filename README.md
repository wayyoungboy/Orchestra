...
- **Agent Session Inspection**: View active workspace agent sessions, owning members, current tmux pane snapshots, live output, controlled terminal input, and stale-session termination from a dedicated navigation tab
