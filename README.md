...
- **Agent Session Inspection**: View active workspace agent sessions, owning members, current tmux pane snapshots, live output, and controlled terminal input from a dedicated navigation tab
