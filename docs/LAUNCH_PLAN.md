...
> Keep agent sessions alive with tmux, coordinate work in chat, and track tasks from one browser workspace.
...
- [ ] Prepare 3 short clips: session persistence, multi-agent chat, Kanban task handoff.
